    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp12} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 12</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Manic Pixie Crap Show"',
                                'Episode 2 "Desorden de cristal"',
                                'Episode 3 "El Pumpkinening"',
                                'Episode 4 "Conduciendo un gran maniquí"',
                                'Episode 5 "Siete preadolescentes otra vez"',
                                'Episode 6 "Playa, por favor"',
                                'Episode 7 "Loft en Bedslation"',
                                'Episode 8 "Atrapado en la cocina contigo"',
                                'Episode 9 "FOMO que no lo hiciste"',
                                'Episode 10 "Las vacaciones de Navidad de Gene"',
                                'Episode 11 "Toque de Valor(uaciones)"',
                                'Episode 12 "Ferry en My Wayward Bob y Linda"',
                                'Episode 13 "Nudo de fragata"',
                                'Episode 14 "El video mató a la estrella de Gene-io"',
                                'Episode 15 "Antiguo que se porta mal"',
                                'Episode 16 "Entrevista con un pop-pop-pire"',
                                'Episode 17 "Las reglas de la Casa de la Araña"',
                                'Episode 18 "Jengibre claro y presente"',
                                'Episode 19 "A-Brote un niño"',
                                'Episode 20 "Historia paralela de la salsa"',
                                'Episode 21 "Some Like It Bot Parte 1: Corredor de octavo grado"',
                                'Episode 22 "Some Like It Bot Parte 2: Día del Juece"',

                            ].map((ep, index) => (
                                <button
                                key={index}
                                className="episodioBtn"
                                onClick={() => router.push(`/reproductorvideo?season=12&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
