    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp8} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 8</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Brunchsquatch"',
                                'Episode 2 "El silencio de la Luisa"',
                                'Episode 3 "El lobo de Wharf Street"',
                                'Episode 4 "Siéntame, nena, una vez más"',
                                'Episode 5 "Acaparamiento de agradecimientos"',
                                'Episode 6 "Lo Sombrío, Parte 1"',
                                'Episode 7 "Lo Sombrío, Parte 2"',
                                'Episode 8 "V de Valentine-detta"',
                                'Episode 9 "Y Tu Ga-Ga También"',
                                'Episode 10 "La Cerámica Secreta Sala de los Secretos"',
                                'Episode 11 "Durmiendo con el amigo enemigo"',
                                'Episode 12 "El fútbol herido"',
                                'Episode 13 "Anímate, Sleepy Gene"',
                                'Episode 14 "El problema de los dobles"',
                                'Episode 15 "Vamos Tina en la montaña"',
                                'Episode 16 "¿Estás ahí, Bob? Soy yo, cumpleaños"',
                                'Episode 17 "Reloj de chico"',
                                'Episode 18 "Mientras camino por el callejón de la sombra de las rampas"',
                                'Episode 19 "Problemas de Mo Mommy Mo"',
                                'Episode 20 "Misión Impos-slug-ble"',
                                'Episode 21 "Algo viejo, algo nuevo, algo que Bob te atiende"',
                                ...
                                onClick={() => router.push(`/reproductorvideo?season=8&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
