    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp13} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 13</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "A Bob, o no a Bob"',
                                'Episode 2 "El espectáculo de Reeky Lake"',
                                'Episode 3 "¿Y el trabajo?"',
                                'Episode 4 "Cometa de errores"',
                                'Episode 5 "Así que apestas, puedes bailar"',
                                'Episode 6 "¡Acelgas de manzana! (pero no sangriento)"',
                                'Episode 7 "Gen de jugador listo"',
                                'Episode 8 "Dar putts"',
                                'Episode 9 "Mostrar a Mamá desde la tumba"',
                                'Episode 10 "La difícil situación antes de Navidad"',
                                'Episode 11 "Tramposo Tramposo Bang Bang"',
                                'Episode 12 "Oh, fila que no lo hiciste."',
                                'Episode 13 "¡Parar! ¡O mi mamá será detective!"',
                                'Episode 14 "Estas botas están hechas para acechar"',
                                'Episode 15 "El espectáculo (y contar) debe continuar"',
                                'Episode 16 "Lo que cree un inocente"',
                                'Episode 17 "Cuervos Encuentros de la Especie Pájaro"',
                                'Episode 18 "Tarjeta de regalo o compra probando"',
                                'Episode 19 "Cangrejo absolutamente fabuloso"',
                                'Episode 20 "Radio: No, no lo hiciste."',
                                'Episode 21 "Puntero láser Mother Author"',
                                'Episode 22 "Amelia"',
                                ...
                                onClick={() => router.push(`/reproductorvideo?season=13&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
