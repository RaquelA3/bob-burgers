    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp10} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 10</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "El anillo (pero no da miedo)"',
                                'Episode 2 "Los chicos solo quieren tener hongos"',
                                'Episode 3 "Motor, ella barco"',
                                'Episode 4 "Problemas de cerdos en Little Tina"',
                                'Episode 5 "Leyendas del Centro Comercial"',
                                'Episode 6 "The Hawkening: ¡Mira quién está vendiendo ahora!"',
                                'Episode 7 "Tierra del Desván"',
                                'Episode 8 "Ahora no estamos cocinando con gas"',
                                'Episode 9 "Todo ese gen"',
                                'Episode 10 "Que tengas una Navidad de Maily Linda"',
                                'Episode 11 "Tambor perdonado"',
                                'Episode 12 "Un pez llamado Tina"',
                                'Episode 13 "Tres chicas y un pequeño muelle"',
                                'Episode 14 "Mueve la canción"',
                                'Episode 15 "Yurty Rotten Scoundrels"',
                                'Episode 16 "Flat-Top de la mañana para ti"',
                                'Episode 17 "Solo el viaje"',
                                'Episode 18 "Tappy Tappy Tappy Tap Tap Tap"',
                                'Episode 19 "La lata de manitas"',
                                'Episode 20 "¡Caca!... No lo volví a hacer"',
                                'Episode 21 "Local She-ro"',
                                'Episode 22 "Gastarte una broma por ser un amigo"',

                            ].map((ep, index) => (
                                <button
                                key={index}
                                className="episodioBtn"
                                onClick={() => router.push(`/reproductorvideo?season=10&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
