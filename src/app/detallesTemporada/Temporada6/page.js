    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp6} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 6</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Bobs deslizantes"',
                                'Episode 2 "El Barco Terrestre"',
                                'Episode 3 "El embrujo"',
                                'Episode 4 "Gayle Makin\' Bob Trineo"',
                                'Episode 5 "Nice-Capades"',
                                'Episode 6 "La cocinera, el Steve, la Gayle y su amante"',
                                'Episode 7 "El show de Gene y Courtney"',
                                'Episode 8 "Sexy Danza Sanadora"',
                                'Episode 9 "Sofá Sagrado"',
                                'Episode 10 "Piojos Las cosas son piojos"',
                                'Episode 11 "Casa de los 1000 rebotes"',
                                'Episode 12 "Apoye a Gene"',
                                'Episode 13 "Mover el cerdo"',
                                'Episode 14 "Las hormonas-iums"',
                                'Episode 15 "Pro Tiki/Con Tiki"',
                                'Episode 16 "Adiós Adiós Boo Boo"',
                                'Episode 17 "El jinete de caballos"',
                                'Episode 18 "Almirante secreto"',
                                'Episode 19 "Pegado, ¿dónde está mi Bob?"',
                                ...
                                onClick={() => router.push(`/reproductorvideo?season=6&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
