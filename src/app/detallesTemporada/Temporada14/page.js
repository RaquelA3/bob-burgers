    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp14} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 14</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Pelea en la Tarea No Está Bien"',
                                'Episode 2 "El Asombroso Rudy"',
                                'Episode 3 "El pepinillo"',
                                'Episode 4 "Atropellando un gen"',
                                'Episode 5 "Intimidar o no"',
                                'Episode 6 "¿Escapar de qué isla?"',
                                'Episode 7 "El Rey (Mapache) y yo"',
                                'Episode 8 "¿Muelle, me preocupa?"',
                                'Episode 9 "Fraude de los muertos: Zombie-docu-pocalypse"',
                                'Episode 10 "Pesadilla 2 días antes de Navidad"',
                                'Episode 11 "Misión Impossi-Bob"',
                                'Episode 12 "Jade en la sombra"',
                                'Episode 13 "Sudor y miedos"',
                                'Episode 14 "El gran Stieblitzki"',
                                'Episode 15 "Las cosas difíciles correctas"',
                                'Episode 16 "Para atrapar una carne de res"',

                            ].map((ep, index) => (
                                <button
                                key={index}
                                className="episodioBtn"
                                onClick={() => router.push(`/reproductorvideo?season=14&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
