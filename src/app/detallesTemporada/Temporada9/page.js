    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp9} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 9</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Solo uno de los Boyz 4 ahora por ahora"',
                                'Episode 2 "La toma de tiempo de diversión uno dos tres"',
                                'Episode 3 "Tweemprendedores"',
                                'Episode 4 "Pesadilla en la calle Ocean Avenue"',
                                'Episode 5 "Vive y deja volar"',
                                'Episode 6 "Bobby Conductor"',
                                'Episode 7 "Te perdono"',
                                'Episode 8 "¿Rodillo? ¡Apenas la conozco!"',
                                'Episode 9 "OVNI No, no lo hiciste"',
                                'Episode 10 "Trineo Mejor Off"',
                                'Episode 11 "¿El aceite de Lorenzo? No, la de Linda"',
                                'Episode 12 "La caza de Helen"',
                                'Episode 13 "Cama, Bob y más allá"',
                                'Episode 14 "En todos los sentidos, menos en el ganso"',
                                'Episode 15 "El Princ-ipal Fresco"',
                                'Episode 16 "Deambulando Bob-iday"',
                                'Episode 17 "¿Qué pasa con Bob?"',
                                'Episode 18 "Si te gusta tanto, ¿por qué no haces marionetas?"',
                                'Episode 19 "Oyente desde hace mucho tiempo, Bob por primera vez"',
                                'Episode 20 "La Milla Genética"',
                                'Episode 21 "P.T.A. No es así"',
                                'Episode 22 "Sí, sin mi Zeke"',
       
                            ].map((ep, index) => (
                                <button
                                key={index}
                                className="episodioBtn"
                                onClick={() => router.push(`/reproductorvideo?season=9&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
