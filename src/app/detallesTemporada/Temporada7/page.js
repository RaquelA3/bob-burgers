    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp7} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 7</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Grip-ouise"',
                                'Episode 2 "Sea Me Ahora"',
                                'Episode 3 "Adolescente-una bruja"',
                                'Episode 4 "Sirven a los caballos, ¿no?"',
                                'Episode 5 "Hermano mayor, ¿dónde te tiras un pedo?"',
                                'Episode 6 "Los Quirk-ducers"',
                                'Episode 7 "La última casa de jengibre a la izquierda"',
                                'Episode 8 "Ex MachTina"',
                                'Episode 9 "Bob en realidad"',
                                'Episode 10 "No hay negocio como Mr. Business Business"',
                                'Episode 11 "Unos pocos hombres de \'gurt"',
                                'Episode 12 "Como el gen del chocolate"',
                                'Episode 13 "El Hotel Grand Mama-pest"',
                                'Episode 14 "Acuatismo"',
                                'Episode 15 "No me pierdo debatiendo"',
                                'Episode 16 "Huevos por días"',
                                'Episode 17 "Cero Larp Treinta"',
                                'Episode 18 "El Laser-inth"',
                                'Episode 19 "Thelma y Louise, excepto que Thelma es Linda"',
                                'Episode 20 "Mamá, mentiras y cinta de video"',
                                'Episode 21 "Desfile de la Carroza Perdida"',
                                'Episode 22 "En lo suave"',
                                
                            ].map((ep, index) => (
                                <button
                                key={index}
                                className="episodioBtn"
                                onClick={() => router.push(`/reproductorvideo?season=7&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
