    ...
    return (
        <div className="bob-container5">
            ...
            <div className="contenedor-temporada">
                 <img className="imagenTemporada" src={imagenesTemporadas.temp4} alt="imagenT"/>  
                 
                 <div className="detalles-temporada">
                     <h1 className="titulo-serie">Bob Burgers</h1>
                     <h2 className="titulo-temporada">Temporada 4</h2>
                     <label className="descripcion-temporada">A tiny VS Code extension made up of a few commands that generate and insert lorem ipsum text into a text file. To use the extension, open the command palette (F1 or cmd/ctrl+shift+p, type "lorem ipsum" and select to insert either a line or paragraph.</label>
                        ...
                        <div className="cuadro-episodiosTemporada">
                            ...
                            {[
                                'Episode 1 "Un río corre a través de Bob"',
                                'Episode 2 "Noche de Fuerte"',
                                'Episode 3 "¡Hidroavión!"',
                                'Episode 4 "Mi gran y gordo Bob griego"',
                                'Episode 5 "Pavo en lata"',
                                'Episode 6 "Unión de lluvia púrpura"',
                                'Episode 7 "Bob y entregar"',
                                'Episode 8 "Navidad en el coche"',
                                'Episode 9 "Fiestas de pijamas"',
                                'Episode 10 "Presto Tina-o"',

                                'Episode 11 "Fácil de comercializar, fácil de ir"',
                                'Episode 12 "Los archivos de la fronda"',
                                'Episode 13 "Mazel Tina"',
                                'Episode 14 "Tío Teddy"',
                                'Episode 15 "Los niños roban un tren"',
                                'Episode 16 "Saco Psy-chic de ti"',

                                'Episode 17 "Los Ecuestranautas"',
                                'Episode 18 "Ámbar gris"',
                                'Episode 19 "Los niños huyen"',
                                'Episode 20 "Géntalo"',

                                'Episode 21 "Caballo del muelle"',
                                'Episode 22 ""Muelle Mundial II: El Muelle""',
                                ...
                                onClick={() => router.push(`/reproductorvideo?season=4&episode=${index + 1}`)}
                                >
                                {ep}
                                </button>
                            ))}
